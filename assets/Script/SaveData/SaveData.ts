...
export class SaveData {
     ...
     * 装备槽
     */
    equipmentSlot: Map<EquipmentType, EquipmentSlot>;
    ...
    constructor(level: number, experience: number, equipmentSlot: Map<EquipmentType, EquipmentSlot>, storehouse: StorehouseType, chapterName: string, areaName: string, stageName: string, talents: Map<string, number>, enemyRecord: Map<string, number>, ledger: Map<string, LedgerRecord[]>) {
        this.level = level ?? 0;
        this.experience = experience ?? 0;
        this.equipmentSlot = equipmentSlot ?? new Map<EquipmentType, EquipmentSlot>();
